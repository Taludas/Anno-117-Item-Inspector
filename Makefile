...
# exe make targets ###########################
exe: libs
	pyinstaller --onefile --windowed --add-data "data;data" --add-data "items_export_with_effects.csv;." --icon="app_icon.ico" --version-file="file_version_info.txt" --name "Anno 117 Item Inspector" $(PACKAGE).py
